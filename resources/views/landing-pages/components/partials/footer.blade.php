        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-white my-4">من المعروف منذ زمن طويل أن القارئ سوف ينشغل بالمحتوى المقروء لصفحة ما عند النظر إلى تخطيطها. </p>
                ...
                <div class="col-md-2 mt-md-0 mt-4">
                    <h5 class="mb-4 text-white">الروابط</h5>
                    <ul class="m-0 p-0 list-unstyled text-white">
                        <li class="mb-3">عناء</li>
                        <li class="mb-3">المميزات</li>
                        <li class="mb-3">التعليقات</li>
                        <li>فريق</li>
                    </ul>

                </div>
                <div class="col-md-2 mt-md-0 mt-4">
                    <h5 class="mb-4 text-white">المساعده</h5>
                    <ul class="m-0 p-0 list-unstyled text-white">
                        <li class="mb-3" i>جسابي</li>
                        <li class="mb-3">الإرجاعات والاسترداد</li>
                        <li class="mb-3">سياسة الدفع</li>
                        <li>الاسئله الشائعه</li>
                    </ul>
                </div>
                <div class="col-md-4 mt-md-0 mt-4">
                    <h5 class="mb-4 text-white">النشرة الإخبارية</h5>
            ...
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <p class="mb-0">©
                        ...
                        </script> جميع الحقوق محفوظة لـ ALAOI.
                    </p>
                </div>
            </div>
        </div>
